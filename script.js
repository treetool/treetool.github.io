var system_type = [
  "<h2 class='die-result-heading'>MRS:</h2><h2 class='die-result-subheading'>Closed / Traditional</h2><p class='die-result-desc'>MRS using the tail end of the rope to form the bridge and climbing hitch.</p>",
  "<h2 class='die-result-heading'>MRS:</h2><h2 class='die-result-subheading'>Split Tail / Open</h2><p class='die-result-desc'>MRS using a mechanical hitch or cordage splittail — typically an eye&nbsp;to&nbsp;eye sling for closed hitches or single eye for a Blake's hitch.",
  ...
  "<h2 class='die-result-heading'>Tyrolean:</h2><h2 class='die-result-subheading'>Static / Fixed</h2><p class='die-result-desc'>Climber is on a Tyrolean traverse with a fixed-length non-adjustable tether (no up/down). Think fixed cowstail, sling or zipline tether.</p><p class='die-result-desc'>System is able to traverse along the line if in a 'Functional' state.</p>"
];


var climber_system_state = [
  "<h2 class='die-result-heading'>Weighted:</h2><h2 class='die-result-subheading'>Non-functional</h2><p class='die-result-desc'>Climber is resting with their weight on the climbing system, and that system WILL NOT ascend or descend — the system is completely seized.</p>",
